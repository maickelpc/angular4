...
export class OrderComponent implements OnInit {
  ...
  delivery: number = 8; //Itemfixado, mas numa aplicação real, deveria buscar no backend
  ...
  ngOnInit() {
    ...
    }, {validator: OrderComponent.equalsTo}) // para validação comparando mais de um campo.
  }
